...
const getCurrentUser = asyncHandler(async (req, res) => {
  return res
    .status(200)
    .json(new ApiResponse(200, req.user, "currect user fectched successfully"));
});
...
const updateUserCover = asyncHandler(async (req, res) => {
  ...
  if (!coverImage.url) {
    throw new ApiError(400, "Error while uploding cover");
  }
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, channel[0], "User channel fetchend succesfully")
    );
